define(['js/module.js'], function(controllers) {
    controllers.controller('regSuccess2Ctrl', function($scope, resourceService, $filter, $rootScope, $state, $localStorage) {
        $rootScope.title = '嗷呜宝';
        var browser = {
            versions: function() {
        ...
        $scope.downloadclick2 = function() {
            if (browser.versions.ios || browser.versions.iPhone || browser.versions.iPad) {
                ...
                window.location.href = "https://m.aowubao.com/awb_app_chubao.apk";
            } else {
                window.location.href = "https://m.aowubao.com/awb_app_chubao.apk";
            }
        }
