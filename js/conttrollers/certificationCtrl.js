...
define(['js/module.js', 'jquery', 'ngdialog'], function(controllers, $, ngdialog) {
    controllers.controller('certificationCtrl', function($scope, resourceService, $filter, $http, $state, $rootScope, $localStorage, ngDialog) {
        ...
        $scope.submit = function() {
            ...
            resourceService.queryPost($scope, $filter('getUrl')('实名认证'), $scope.userForm, '实名认证');
